...
public class LeftSideToolbarDrawer extends Drawer {
    LeftSideToolbarDrawer(final Activity activity, android.support.v7.widget.Toolbar toolbar, final Drawer.Result result)
    {
        ...
        withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                    if (drawerItem instanceof Nameable) {
                        ...
                        if(activity.getString(((Nameable) drawerItem).getNameRes()) == activity.getString(R.string.drawer_item_points)){
